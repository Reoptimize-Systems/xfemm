...
void femmcli::LuaElectrostaticsCommands::registerCommands(LuaInstance &li)
{
    ...
    li.addFunction("ei_get_material", LuaCommonCommands::luaGetMaterialFromLib);
    li.addFunction("ei_getmaterial", LuaCommonCommands::luaGetMaterialFromLib);
    ...
    li.addFunction("ei_set_segment_prop", LuaCommonCommands::luaSetSegmentProperty);
    li.addFunction("ei_setsegmentprop", LuaCommonCommands::luaSetSegmentProperty);
