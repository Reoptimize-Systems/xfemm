...
%     vars.MEXFLAGS = ['${MEXFLAGS} -I"postproc" -I"../cfemm/fpproc" -I"../cfemm/libfemm" -I"../cfemm/libfemm/liblua" ', trilibraryflag];
    ...
    vars.OBJS = { ...
      ... % liblua
      '../cfemm/libfemm/liblua/femmcomplex.${OBJ_EXT}', ...
    ...
    rules(end+1).target = '../cfemm/libfemm/liblua/femmcomplex.${OBJ_EXT}';
    rules(end).deps = '../cfemm/libfemm/liblua/femmcomplex.h';
...
%     rules(end).deps = '../cfemm/libfemm/cuthill.h';
    ...
    rules(end+1).target = '../cfemm/libfemm/PostProcessor.${OBJ_EXT}';
    rules(end).deps = '../cfemm/libfemm/PostProcessor.h';
