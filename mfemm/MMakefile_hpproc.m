function [rules,vars] = MMakefile_hpproc ()
...
%     mfemmdeps.getmfilepath (mfilename);
    ...
    vars.MEXFLAGS = ['${MEXFLAGS} -g -I"postproc" -I"../cfemm/hpproc" -I"../cfemm/libfemm" -I"../cfemm/libfemm/liblua" ', trilibraryflag];
