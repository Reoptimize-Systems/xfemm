...
%
    ...
    if isfield (BlockLabel, 'MagDirFctn') ...
            && isempty (BlockLabel.MagDirFctn) ...
            && isnumeric (BlockLabel.MagDir) ...
    ...
    if isfield (BlockLabel, 'MagDirFctn') && ~isempty (BlockLabel.MagDirFctn)
