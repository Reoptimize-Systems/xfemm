...
// I am going to enforce ANSI C at all times
#ifndef SS_ANSI
#define SS_ANSI
#endif
...
//		}
    ...
    void BufferRel()
    {
        RelBuf();    // backwards compatability
    }
    CT*  Buffer()
    {
        return GetBuf();    // backwards compatability
    }
    CT*  BufferSet(int nLen)
    {
        return SetBuf(nLen);    // backwards compatability
    }
