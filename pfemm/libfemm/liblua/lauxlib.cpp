...
LUALIB_API CComplex luaL_check_number (lua_State *L, int narg)
{
    CComplex d = lua_tonumber(L, narg);
// return d
...
LUALIB_API CComplex luaL_opt_number (lua_State *L, int narg, double def)
{
