...
LUALIB_API CComplex luaL_check_number (lua_State *L, int numArg);
LUALIB_API CComplex luaL_opt_number (lua_State *L, int numArg, double def);
...
#define luaL_check_int(L,n)	((int) Re(luaL_check_number(L, n)))
#define luaL_check_long(L,n)	((long) Re(luaL_check_number(L, n)))
#define luaL_opt_int(L,n,d)	((int) Re(luaL_opt_number(L, n,d)))
#define luaL_opt_long(L,n,d)	((long) Re(luaL_opt_number(L, n,d)))
